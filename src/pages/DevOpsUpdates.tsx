...
import { Server, Bug, Megaphone, BookOpen, Calendar, Link as LinkIcon } from "lucide-react";
...
const DevOpsUpdates = () => {
  ...
  const { data: updates, isLoading } = useQuery({
    queryKey: ["devops-updates", selectedType],
    queryFn: async () => {
      console.log("Fetching DevOps updates with type:", selectedType);
      let query = supabase.from("devops_updates").select("*");
      ...
      console.log("Fetched DevOps updates:", data);
      return data;
    },
  });
          ...
          <div className="relative px-6 py-24 mx-auto max-w-7xl">
            ...
            >
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600 font-['Inter']">
                Stay up to date with the latest features, bug fixes, and announcements from the DevOps ecosystem
              </p>
            </motion.div>
          </div>
        </div>
